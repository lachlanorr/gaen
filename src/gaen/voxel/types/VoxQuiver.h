//------------------------------------------------------------------------------
// VoxQuiver.h - Voxel Quiver Geometry
//
...
#ifndef GAEN_VOXEL_VOX_QUIVER_H
#define GAEN_VOXEL_VOX_QUIVER_H
...
struct VoxQuiver : public VoxObj
{
    VoxQuiver(const std::shared_ptr<QbtNode> & pRootNode, const VoxObjType & type)
...
#endif // #ifndef GAEN_VOXEL_QUIVER_H
