...
#include "gaen/engine/messages/SpritePlayAnim.h"
#include "gaen/engine/messages/SpriteVelocity.h"
#include "gaen/engine/messages/SpriteBody.h"
...
MessageResult SpriteMgr::message(const T & msgAcc)
{
    ...
    case HASH::sprite_insert:
    {
        ...
        SpriteInstance * pSpriteInstRenderer = GNEW(kMEM_Renderer, SpriteInstance, pSpriteRenderer, pSpriteInst->stageHash(), pSpriteInst->pass(), pSpriteInst->isVisible(), pSpriteInst->mTransform);
...
i32 sprite_create(AssetHandleP pAssetHandle, i32 stageHash, i32 passHash, const mat43 & transform, Entity * pCaller)
{
    ...
    SpriteInstance * pSpriteInst = GNEW(kMEM_Engine, SpriteInstance, pSprite, stageHash, pass_from_hash(passHash), pCaller->isVisible(), transform);
