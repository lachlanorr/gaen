...
Entity * Registry::constructEntity(u32 nameHash, u32 childCount, task_id creatorTask, u32 readyMessage)
{
    auto it = mEntityConstructors.find(nameHash);
    ...
    Entity * pEntity = it->second(childCount, creatorTask, readyMessage);
