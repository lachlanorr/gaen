...
static const task_id kEditorTaskId       = kMaxTaskId - 8; // 268435447
static const task_id kPrimaryTaskIdMin   = kMaxTaskId - 8; // 268435447 -- Change as appropriate if we add more "primary" task ids
